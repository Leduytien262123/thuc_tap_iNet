<template>
  <div class="w-full">
    ...
    <CmsTrangChuFooter
      ...
      v-model:contents="response[1].Metadata.data_footer"
      v-model:contact="response[2].Metadata.data_footer"
      v-model:categories1s="response[3].Metadata.data_footer"
      v-model:categories2s="response[4].Metadata.data_footer"
      v-model:socialMedias="response[5].Metadata.data_footer"
      :response="response"
    />
  </div>
</template>
