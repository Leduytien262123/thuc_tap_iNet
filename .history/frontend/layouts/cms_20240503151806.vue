  ...
  <div class="w-full">
    ...
    <div class="bg-[#F3F3F4]">
      ...
      <CmsTrangChuTsChonChungToi
        ...
        v-model:title1="response[0].Metadata.tschonchungtoi.title"
        v-model:subTitle1="response[0].Metadata.tschonchungtoi.subTitle"
        :response="response"
      />
...
console.log(tschonchungtoi[0].title);
