    ...
    <div class="w-[72%] m-auto">
      <div class="flex items-center justify-between mb-8">
        <h2 class="text-[40px] flex font-semibold">
          Học viên nói gì
          <p class="ml-3 text-[#6046FF]">về chúng tôi</p>
        </h2>
      </div>
    </div>
    <div class="w-full">
...
// const hvNoiGiVeChungToi = data.value;

// let testimonials = ref([]);

// hvNoiGiVeChungToi.forEach((item) => {
//   if (item.Metadata) {
//     if (item.Metadata.data_hvnoigivechungtoi) {
//       testimonials.value = item.Metadata.data_hvnoigivechungtoi;
//     }
//   }
// });
</script>
