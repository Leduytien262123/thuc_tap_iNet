...
if (props.response && props.response[0]?.Metadata?.data_footer) {
  props.response[0].Metadata.data_footer.forEach((item, index) => {
    switch (index) {
      case 0:
        if (item.logoUrl) logoUrl.value = item.logoUrl;
        break;
      case 1:
        if (item.content) content.value = item.content;
        break;
      case 2:
        if (item.contacts) contacts.value = item.contacts;
        break;
      case 3:
        if (item.categories1) categories1.value = item.categories1;
        break;
      case 4:
        if (item.categories2) categories2.value = item.categories2;
        break;
      case 5:
        if (item.socialMedia) socialMedia.value = item.socialMedia;
        break;
      default:
        break;
    }
