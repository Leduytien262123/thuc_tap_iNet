...
//   try {
//     // Step 1: Tạo bản sao của mảng response để chỉnh sửa
//     const newData = response.map((item) => ({ ...item }));

//     // Step 2: Thực hiện chỉnh sửa dữ liệu mới
//     newData.forEach((item) => {
//       // Ví dụ: Thêm một trường mới vào mỗi phần tử
//       item.newField = "New Value";
//     });

//     // Step 3: Gửi yêu cầu PATCH để lưu dữ liệu mới
//     const patchResponse = await fetch("http://localhost:8000/page", {
//       method: "PATCH",
//       headers: {
//         "Content-Type": "application/json",
//       },
//       body: JSON.stringify({ value: newData }), // Đảm bảo gửi dữ liệu mới lên server
//     });

//     if (!patchResponse.ok) {
//       throw new Error("Yêu cầu PATCH thất bại");
//     }
