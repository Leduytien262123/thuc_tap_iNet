...
// const editData = ref({
//   editData_baivietnoibat: response[0]?.Metadata?.data_baivietnoibat ?? {},
//   editData_banner: response[0]?.Metadata?.data_banner ?? {},
//   editData_danhmuckhoahoc: response[0]?.Metadata?.data_danhmuckhoahoc ?? {},
//   editData_doitactieubieu: response[0]?.Metadata?.data_doitactieubieu ?? {},
//   editData_form: response[0]?.Metadata?.data_form ?? {},
//   editData_giangvientieubieu:
//     response[0]?.Metadata?.data_giangvientieubieu ?? {},
//   editData_goikhoahoctieubieu:
//     response[0]?.Metadata?.data_goikhoahoctieubieu ?? {},
//   editData_hvnoigivechungtoi:
//     response[0]?.Metadata?.data_hvnoigivechungtoi ?? {},
//   editData_khoahocnoibat: response[0]?.Metadata?.data_khoahocnoibat ?? {},
//   editData_khoahoctieubieu: response[0]?.Metadata?.data_khoahoctieubieu ?? {},
//   editData_menus: response[0]?.Metadata?.data_menus ?? {},
//   editData_sumenhvatamnhin: response[0]?.Metadata?.data_sumenhvatamnhin ?? {},
//   editData_thongso: response[0]?.Metadata?.data_thongso ?? {},
//   editData_tschonchungtoi: response[0]?.Metadata?.data_tschonchungtoi ?? {},
//   editData_vechungtoi: response[0]?.Metadata?.data_vechungtoi ?? {},
// });
