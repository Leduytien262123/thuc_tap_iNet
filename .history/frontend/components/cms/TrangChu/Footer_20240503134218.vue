...
const saveChanges = () => {
  ...
  contacts.value = editData.value.editContacts.push((contact) => ({
    id: contact.id,
    iconUrl: contact.editIconUrl,
    text: contact.editText,
    link: contact.editLinkContacts,
  }));
  categories1.value = editData.value.editCategories1.push((category) => ({
    title: category.editTitle,
    items: category.items.push((item) => ({
      id: item.id,
      text: item.editName,
      link: item.editLink,
    })),
  }));
  categories2.value = editData.value.editCategories2.push((category) => ({
    title: category.editTitle,
    items: category.items.push((item) => ({
      id: item.id,
      text: item.editName,
  ...
  // console.log(editData.value);
  socialMedia.value = editData.value.editSocialMedia.push((socialMedia) => ({
    id: socialMedia.id,
