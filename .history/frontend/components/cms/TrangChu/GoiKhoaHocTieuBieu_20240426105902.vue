...
// const goiKhoaHocTieuBieu = data.value;

// let courses = ref([]);

// goiKhoaHocTieuBieu.forEach((item) => {
//   if (item.Metadata) {
//     if (item.Metadata.data_goikhoahoctieubieu) {
//       courses.value = item.Metadata.data_goikhoahoctieubieu;
//     }
//   }
// });
