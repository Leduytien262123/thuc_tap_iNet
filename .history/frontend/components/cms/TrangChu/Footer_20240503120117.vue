...
const logoUrl = ref(logoUrls[0].value);
const content = ref(contents[1].value);
const contacts = ref(contact[2].value);
const categories1 = ref(categories1s[3].value);
const categories2 = ref(categories2s[4].value);
const socialMedia = ref(socialMedias[5].value);
