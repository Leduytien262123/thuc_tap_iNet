...
const saveData = async () => {
  try {
    // Step 1: Lấy dữ liệu cũ từ server
    ...
    console.log("Data received from server:", oldData);

    // Step 2: Tạo bản sao của dữ liệu cũ để chỉnh sửa
    const newData = { ...oldData };

    // Step 3: Thực hiện chỉnh sửa dữ liệu mới
    newData.Metadata.key = "home_page";
    newData.Metadata.label = "Trang";
    newData.Metadata.Link = "/";

    // Step 4: Gửi yêu cầu PATCH để lưu dữ liệu mới
