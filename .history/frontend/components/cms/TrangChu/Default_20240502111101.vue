...
// Tạo một bản sao của dữ liệu ban đầu để lưu các chỉnh sửa
let editedData = originalData.map((item) => ({ ...item }));

// Hàm để lưu các chỉnh sửa và cập nhật trong cơ sở dữ liệu
const saveData = () => {
