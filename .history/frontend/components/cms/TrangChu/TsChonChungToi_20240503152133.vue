...
const item2 = defineModel("item2");
const title = ref(item2.value.title);
const subTitle = ref(item2.value.subTitle);
...
const saveChanges = () => {
  ...
  item2.value.title = title.value;
  subTitle.value = editData.value.editSubTitle;
  item2.value.subTitle = subTitle.value;
