  ...
  <div class="w-[72%] m-auto pt-4 relative">
    ...
    <n-modal v-model:show="editMode">
      <n-card
        ...
        aria-modal="true"
      >
        <template #header-extra> {{ aboutUs.value.name }} </template>
        <div class="w-full">
...
const saveChanges = () => {
  ...
  editData.value.editAbout.forEach((editAbout, index) => {
    aboutUs.value[index].img1 = editAbout.editImg1;
    aboutUs.value[index].img2 = editAbout.editImg2;
    aboutUs.value[index].name = editAbout.editName;
    aboutUs.value[index].text = editAbout.editText;
    aboutUs.value[index].title = editAbout.editTitle;
  });
