...
contents.value.forEach((content, index) => {
  editData.value.editContents.push({
    id: content.id,
    editNameTitle: content.nameTitle,
    editDescription: content.description,
    editImage: content.image,
    editTag1: content.tag1,
    editTag2: content.tag2,
    editLink: content.link,
  });
});
...
const saveChanges = () => {
  ...
  article2.value.title = title.value;
  subTitle.value = editData.value.editSubTitle;
  article2.value.subTitle = subTitle.value;
