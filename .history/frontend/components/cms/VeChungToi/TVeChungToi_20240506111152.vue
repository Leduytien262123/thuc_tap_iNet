...
const saveChanges = () => {
  ...
  editData.value.editAbout.forEach((about, index) => {
    about.value[index].tieuDe = formData.editTieuDe;
    about.value[index].linkTieuDe = formData.editLinkTieuDe;
    about.value[index].logo = formData.editLogo;
    about.value[index].dangNhap = formData.editDangNhap;
    about.value[index].linkDangNhap = formData.editLinkDangNhap;
    about.value[index].dangKy = formData.editDangKy;
      img1: about.editImg1,
      img2: about.editImg2,
      name: about.editName,
      text: about.editText,
      title: about.editTitle,
  });
