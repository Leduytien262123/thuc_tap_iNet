...
<script setup>
import { useMessage, ref, defineModel, defineProps } from "vue";
...
const saveChanges = () => {
  editMode.value = false;
  aboutUs.value = [];
  editData.value.editAbout.forEach((editAbout, index) => {
    if (about.value[index]) {
      about.value[index].img1 = editAbout.editImg1;
      about.value[index].img2 = editAbout.editImg2;
      about.value[index].name = editAbout.editName;
      about.value[index].text = editAbout.editText;
      about.value[index].title = editAbout.editTitle;
    }
  });
...
const cancelEdit = () => {
  editMode.value = false;
  editData.value.editAbout = [];
  editData.value.editAbout.forEach((about, index) => {
    aboutUs.value.push({
      id: about.id,
      editImg1: about.img1,
      editImg2: about.img2,
