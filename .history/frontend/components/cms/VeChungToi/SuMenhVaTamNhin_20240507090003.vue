              ...
              <div class="h-full pr-8 overflow-y-auto">
                ...
                <div class="mb-4">
                  ...
                  <input
                    type="text"
                    id="menuLessons"
                    v-model="newContents.newNameTitle"
                    class="w-full border rounded p-2 border-gray-500"
                ...
                <div class="mb-4">
                  ...
                  <textarea
                    type="text"
                    id="menuOldPrice"
                    v-model="newContents.newDescription"
                    class="w-full border rounded p-2 border-gray-500"
...
function editAddNewDanhMucKhoaHoc() {
  newContents.value.newImage = "";
  newContents.value.newNameTitle = "";
  newContents.value.newDescription = "";
