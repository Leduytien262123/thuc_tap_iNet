...
const saveChanges = () => {
  ...
  editData.value.editAbout.forEach((about, index) => {
    about.value[index].img1 = formData.editImg1;
    about.value[index].img2 = formData.editImg2;
    about.value[index].name = formData.editName;
    about.value[index].text = formData.editText;
    about.value[index].title = formData.editTitle;
      img1: about.editImg1,
      img2: about.editImg2,
      name: about.editName,
      text: about.editText,
