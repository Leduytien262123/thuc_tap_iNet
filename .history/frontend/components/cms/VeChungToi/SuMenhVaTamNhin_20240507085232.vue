...
const saveChanges = () => {
  ...
  editData.value.editContents.forEach((content, index) => {
    contents.value.push({
      id: content.id,
      nameTitle: content.editNameTitle,
      description: content.editDescription,
      image: content.editImage,
      tag1: content.editTag1,
      tag2: content.editTag2,
      link: content.editLink,
    });
  });
